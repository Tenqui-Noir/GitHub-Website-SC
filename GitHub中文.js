(() => {
  ...
  [
    ...
    ['Build, test, and deploy your code. Make code reviews, branch management, and issue triaging work the way you want. Select a workflow to get started.', '构建、测试和部署你的代码。按你想要的方式进行代码审查、分支管理和议题分类。选择一个工作流开始使用。'],
    ...
    ['Learn more about GitHub Actions', '详细了解 GitHub Actions'],
    ...
    ['Deploy to Alibaba Cloud ACK', '部署到 Alibaba Cloud ACK'],
    ['Deploy to IBM Cloud Kubernetes Service', '部署到 IBM Cloud Kubernetes Service'],
    ['Jekyll using Docker image', '使用 Docker 镜像的 Jekyll'],
    ['Publish Node.js Package', '发布 Node.js 软件包'],
    ['CodeQL Analysis', 'CodeQL 分析'],
    ['Fortify Scan', 'Fortify 扫描'],
    ['Labeler', '标签器'],
    ['Stale', '陈旧项'],
    ['AI issue summary', 'AI 议题摘要'],
    ['Manual workflow', '手动工作流'],
    ['Static HTML', '静态 HTML'],
    ['Getting started and core concepts', '入门和核心概念'],
    ['New to Actions? Start here. Learn the core concepts and how to get started.', '刚接触 Actions？从这里开始。了解核心概念以及如何入门。'],
    ['Configuring and managing workflows', '配置和管理工作流'],
    ['Create custom workflows to control your project\'s life cycle processes.', '创建自定义工作流来控制项目的生命周期流程。'],
    ['Language and framework guides', '语言和框架指南'],
    ['Guides for projects written in many programming languages.', '适用于多种编程语言项目的指南。'],
    ['Checks for stale issues and pull requests', '检查陈旧的议题和拉取请求'],
    ['Any language', '任意语言'],
    ['By', '由'],
    ['Suggested for this repository', '为此仓库推荐'],
    ['Skip this and', '跳过此步骤并'],
    ['set up a workflow yourself', '自己设置工作流'],
    ['Publishes a Node.js package to npm.', '将 Node.js 软件包发布到 npm。'],
    ['Test your Deno project', '测试你的 Deno 项目'],
    ...
    ['Deploy a container to an Amazon ECS service powered by AWS Fargate or Amazon EC2.', '将容器部署到由 AWS Fargate 或 Amazon EC2 提供支持的 Amazon ECS 服务。'],
    ['Build a docker container, publish it to Google Container Registry, and deploy to GKE.', '构建 Docker 容器，将其发布到 Google Container Registry，并部署到 GKE。'],
    ['Set up Terraform CLI in your GitHub Actions workflow.', '在 GitHub Actions 工作流中设置 Terraform CLI。'],
    ['Deploy a container to Alibaba Cloud Container Service for Kubernetes (ACK).', '将容器部署到 Alibaba Cloud Container Service for Kubernetes (ACK)。'],
    ['Build a docker container, publish it to IBM Cloud Container Registry, and deploy to IBM Cloud Kubernetes Service.', '构建 Docker 容器，将其发布到 IBM Cloud Container Registry，并部署到 IBM Cloud Kubernetes Service。'],
    ['This workflow will build a docker container, publish and deploy it to Tencent Kubernetes Engine (TKE).', '此工作流将构建 Docker 容器，并将其发布和部署到 Tencent Kubernetes Engine (TKE)。'],
    ['Security analysis from GitHub for C, C++, C#, Go, Java, JavaScript, TypeScript, Python, Ruby, Kotlin and Swift developers.', '面向 C、C++、C#、Go、Java、JavaScript、TypeScript、Python、Ruby、Kotlin 和 Swift 开发者的 GitHub 安全分析。'],
    ['Static analysis of code for vulnerability detection, covering 26+ languages. Start cleaning your code in minutes!', '用于漏洞检测的代码静态分析，覆盖 26+ 种语言。几分钟内即可开始清理代码！'],
    ['Integrate Fortify\'s comprehensive static code analysis (SAST) for 33+ languages into your DevSecOps workflows.', '将 Fortify 面向 33+ 种语言的综合静态代码分析（SAST）集成到你的 DevSecOps 工作流中。'],
    ['Run Datadog Synthetic tests within your GitHub Actions workflow', '在 GitHub Actions 工作流中运行 Datadog Synthetic 测试'],
    ['Build and test a Crystal project.', '构建并测试 Crystal 项目。'],
    ['Labels pull requests based on the files changed', '根据更改的文件为拉取请求添加标签'],
    ['Summarizes new issues', '总结新议题'],
    ['Simple workflow that is manually triggered.', '手动触发的简单工作流。'],
    ['Deploy static files in a repository without a build.', '无需构建，直接部署仓库中的静态文件。'],
    ['Package a Jekyll site.', '打包 Jekyll 站点。'],
    ['Package a Gatsby site.', '打包 Gatsby 站点。'],
    ['Package a NuxtJS site.', '打包 NuxtJS 站点。'],
    ['Local', '本地'],
    ['Clone', '克隆'],
    ['Which remote URL should I use?', '我应该使用哪种远程 URL？'],
    ['Remote URL selector navigation', '远程 URL 选择器导航'],
    ['Clone with HTTPS', '使用 HTTPS 克隆'],
    ['Clone with SSH', '使用 SSH 克隆'],
    ['Clone with GitHub CLI', '使用 GitHub CLI 克隆'],
    ['Clone with HTTPS url', '使用 HTTPS URL 克隆'],
    ['Clone with SSH url', '使用 SSH URL 克隆'],
    ['Clone with GitHub CLI command', '使用 GitHub CLI 命令克隆'],
    ...
    ['You don\'t have any public SSH keys in your GitHub account.', '你的 GitHub 账户中没有任何公开 SSH 密钥。'],
    ['add a new public key', '添加新的公钥'],
    [', or try cloning this repository via HTTPS.', '，或尝试通过 HTTPS 克隆此仓库。'],
    ['Work fast with our official CLI.', '使用我们的官方 CLI 高效工作。'],
    ['Learn more about the GitHub CLI', '了解更多关于 GitHub CLI 的信息'],
    ['Remote URL selector', '远程 URL 选择器'],
    ...
    ['Your workspaces in the cloud', '你在云端的工作区'],
    ['Create a codespace on main', '在 main 上创建 Codespace'],
    ['Codespace repository configuration', 'Codespace 仓库配置'],
    ['No codespaces', '没有 Codespace'],
    ['You don\'t have any codespaces with this repository checked out', '你还没有签出此仓库的 Codespace'],
    ['Learn more about codespaces...', '了解更多关于 Codespaces 的信息...'],
    ['New with options...', '使用选项新建...'],
    ['Configure dev container', '配置开发容器'],
    ['Manage codespaces', '管理 Codespaces'],
    ['Share a deep link', '分享深层链接'],
    ['What are codespaces?', '什么是 Codespaces？'],
  ...
  const partialTranslations = [
    ...
    [/Codespace usage for this repository is paid for by\s+([A-Za-z0-9_.-]+)\./g, '此仓库的 Codespace 用量付款方：$1。'],
    [/Codespace usage for this repository is paid for by\s*$/g, '此仓库的 Codespace 用量付款方：'],
  ...
  function isVariableGitHubContent(element, value = '') {
    ...
    const fixedGitHubUiText = new Set([
      ...
      'In progress', 'Queued', 'Idle', 'Completed', 'Cancelled', 'Timed out',
      ...
      'Get started with GitHub Actions', 'Search workflows',
      'Deployment', 'Continuous integration', 'Automation',
      'Browse all categories', 'Learn more about GitHub Actions',
      'Deploy Node.js to Azure Web App',
      'Deploy Node.js to Azure Functions App',
      'Deploy to Amazon ECS', 'Build and Deploy to GKE',
      'Deploy to Alibaba Cloud ACK',
      'Deploy to IBM Cloud Kubernetes Service',
      'Jekyll using Docker image', 'Publish Node.js Package',
      'CodeQL Analysis', 'Fortify Scan', 'Labeler', 'Stale',
      'AI issue summary', 'Manual workflow', 'Static HTML',
      'Getting started and core concepts',
      'Configuring and managing workflows',
      'Language and framework guides',
      'Suggested for this repository', 'set up a workflow yourself',
      'Publishes a Node.js package to npm.', 'Test your Deno project',
      ...
      'Package a Jekyll site.', 'Package a Gatsby site.', 'Package a NuxtJS site.',
      'Local', 'Clone', 'Which remote URL should I use?',
      'Remote URL selector navigation', 'Clone with HTTPS', 'Clone with SSH',
      'Clone with GitHub CLI', 'Clone with HTTPS url', 'Copy URL to clipboard',
      'Clone with SSH url', 'Clone with GitHub CLI command',
      'Copy command to clipboard', 'Clone using the web URL.',
      'Use a password-protected SSH key.',
      'You don\'t have any public SSH keys in your GitHub account.',
      'add a new public key', ', or try cloning this repository via HTTPS.',
      'Work fast with our official CLI.', 'Learn more about the GitHub CLI',
      'Remote URL selector', 'Repository actions',
      'Open in GitHub Copilot app', 'Open with GitHub Desktop', 'Open with Visual Studio',
      'Your workspaces in the cloud', 'Create a codespace on main',
      'Codespace repository configuration', 'No codespaces',
      'You don\'t have any codespaces with this repository checked out',
      'Learn more about codespaces...',
      'New with options...', 'Configure dev container', 'Manage codespaces',
      'Share a deep link', 'What are codespaces?',
    ]);
